...
const Setting = () => {
    return <div className="pt-[56px]">
        ...
        <div className="bg-[#F4F5F9] min-h-[100vh] pt-4">
            <Link to="/info-modify" className='flex justify-between bg-white p-4 mb-3 border-y border-y-[#E9ECF5]'>
            ...
            <div className='border-t border-t-[#E9ECF5] mb-3'>
                ...
                <Link to='/about' className='flex justify-between bg-white p-4 border-b border-b-[#E9ECF5]'>
